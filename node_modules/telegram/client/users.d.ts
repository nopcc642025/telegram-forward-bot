...
/** @hidden */
export declare function _getEntityFromString(client: TelegramClient, string: string): Promise<Api.InputPeerUser | Api.TypeUser | Api.TypeChat>;
/** @hidden */
...
/** @hidden */
export declare function _selfId(client: TelegramClient): number | undefined;
