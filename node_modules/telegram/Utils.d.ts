 ...
 */
export declare function getInputMedia(media: any, { isPhoto, attributes, forceDocument, voiceNote, videoNote, supportsStreaming, }?: GetInputMediaInterface): any;
/**
 ...
 * @param markedId
 */
export declare function resolveId(markedId: number): [
    number,
