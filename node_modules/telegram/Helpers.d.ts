 ...
 * @returns {Buffer}
 */
export declare function toSignedLittleBuffer(big: bigInt.BigInteger, number?: number): Buffer;
/**
 ...
 */
export declare function getMinBigInt(arrayOfBigInts: bigInt.BigInteger[]): bigInt.BigInteger;
/**
